  ...
  return (
    <div>
      <div className="mb-6 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
        Internal view — data coverage dashboard
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-zinc-600">
          {totalRestaurants} restaurants across {stats.length} regions. Track
          data completeness across all fields.
        </p>
      </div>
      ...
      <h2 className="mb-4 text-xl font-semibold">Coverage by Region</h2>
